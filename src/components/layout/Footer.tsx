...
export function Footer() {
  return (
    <footer className="border-t border-border bg-background">
      <div className="max-w-7xl mx-auto px-4 py-8 pb-[calc(2rem+env(safe-area-inset-bottom))]">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4 text-xs text-muted">
            ...
            <span>© {new Date().getFullYear()} Kicaunime</span>
          </div>
        </div>

        {/* Disclaimer */}
        <p className="mt-4 text-center text-[11px] text-muted/60 leading-relaxed max-w-2xl mx-auto">
          Kicaunime tidak menyimpan file video di servernya. Semua konten video
